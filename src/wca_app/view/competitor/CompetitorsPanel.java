...
public class CompetitorsPanel extends javax.swing.JPanel {
    ...
    public CompetitorsPanel(Operator operator) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error while creating "
                    + "competitior controller: " + e, "Error",
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        competitor = (Competitor) table.getValueAt(table.getSelectedRow(),
                model.OBJECT_COL);
...
public class MultiDelete extends Thread {
        ...
        public void run() {
            ...
            for (int i : table.getSelectedRows()) {
                Competitor competitor = (Competitor) table
                        .getValueAt(i, CompetitorTableModel.OBJECT_COL);
                j++;
    ...
    protected void refreshEntityView() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error refreshing competitor "
                    + "view: " + e, "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
