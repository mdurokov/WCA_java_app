...
public class ScrambleUpdateFrame extends javax.swing.JFrame {
    ...
    private void loadEntityProperties(Scramble entity) {
        competitionCmb.setSelectedItem(entity.getCompetition_id());
        eventCmb.setSelectedItem(entity.getEvent_id());
        roundTypeCmb.setSelectedItem(entity.getRoundType_id());
        if(entity.getIsExtra()){
            isExtraCmb.setSelectedIndex(0);
        }else{
            isExtraCmb.setSelectedIndex(1);
        }
        groupField.setText(entity.getGroup());
        scrambleNumField.setText(String.valueOf(entity.getScrambleNum()));
        scrambleTxt.setText(entity.getScramble());
